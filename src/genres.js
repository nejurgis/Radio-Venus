...
export const SUBGENRES = {
  ...
  metal:      ['black-metal', 'death-metal', 'doom-metal', 'sludge-metal', 'post-metal', 'grindcore', 'mathcore', 'hardcore', 'thrash', 'stoner-metal', 'screamo'],
...
const GENRE_MAP = {
  ...
  'digital hardcore': ['industrial', 'idm'],  // Atari Teenage Riot, Bogdan Raczynski — not metal
  ...
  'lounge': ['triphop'],
  'dub': ['triphop'],
  'dub metal': ['metal'],               // prevent 'dub' phraseMatch false positive
  ...
  'gaian doom': ['metal'],              // environmental doom metal
  ...
  'gangsta rap': ['hiphop'],
  'hardcore hip hop': ['hiphop'],   // explicit — prevents 'hardcore' phraseMatch → metal
  'emo rap': ['hiphop'],
  'jazz rap': ['hiphop', 'jazz'],
  'rap metal': ['hiphop', 'metal'],
  'nu metal': ['hiphop', 'metal'],
  ...
  'post-grunge': ['altrock'],
  'alternative metal': ['altrock', 'metal'],
  ...
  'hardcore punk': ['metal', 'altrock'],
  'hardcore': ['metal', 'altrock'],
  'california hardcore': ['metal', 'altrock'],
  'modern hardcore': ['metal', 'altrock'],
  ...
  'thrash': ['metal'],
  'grindcore': ['metal'],
  'american grindcore': ['metal'],
  'mathcore': ['metal'],
  'powerviolence': ['metal'],
  'noisecore': ['metal'],
  'voidgrind': ['metal'],
  'screamo': ['metal', 'altrock'],
  'skramz': ['metal', 'altrock'],
  'blackened screamo': ['metal'],
  'chaotic hardcore': ['metal'],
  'neo-crust': ['metal'],
  'experimental black metal': ['metal'],
  'progressive black metal': ['metal'],
  'technical black metal': ['metal'],
  'emotional black metal': ['metal'],
  'dissonant death metal': ['metal'],
  'stoner rock': ['metal', 'altrock'],
  'post-hardcore': ['metal', 'altrock'],
...
const SUBGENRE_MAP = {
  ...
  'gaian doom': 'doom-metal',

  // metal
  'heavy metal': 'heavy-metal',
  'black metal': 'black-metal',
  'autonomous black metal': 'black-metal',
  'ukrainian black metal': 'black-metal',
  'experimental black metal': 'black-metal',
  'progressive black metal': 'black-metal',
  'technical black metal': 'black-metal',
  'emotional black metal': 'black-metal',
  'death metal': 'death-metal',
  'dissonant death metal': 'death-metal',
  'doom metal': 'doom-metal',
  'post-doom metal': 'doom-metal',
  'stoner metal': 'stoner-metal',
  'stoner rock': 'stoner-metal',
  'sludge metal': 'sludge-metal',
  'sludgecore': 'sludge-metal',
  'dub metal': 'sludge-metal',
  'post-metal': 'post-metal',
  'thrash metal': 'thrash',
  'thrash': 'thrash',
  'grindcore': 'grindcore',
  'american grindcore': 'grindcore',
