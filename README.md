...
| 2026-04-16 | **11 new artists** + 2 backup songs for Air: Chris & Cosey, Lamb, Air, Archive, Natural Wonder Beauty Concept, Strange Cargo, Dijit, Leila, Tosca Tango Orchestra, Bows, Thievery Corporation. Also added backup video IDs for Goldfrapp (Felt Mountain), FSOL (Domain), Burial (Shell of Light), Portishead (Strangers). | Hand-curated with EN verification |
